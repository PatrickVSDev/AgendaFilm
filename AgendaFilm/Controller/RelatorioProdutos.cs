        ...
        private void ComposeContent(IContainer container)
        {
            container.PaddingVertical(10).Table(table =>
            {
                ...
                table.Header(header =>
                {
                    ...
                    header.Cell().Element(CellStyle).Text("Fornecedor").FontSize(9).SemiBold();
                    header.Cell().Element(CellStyle).Text("Garantia").FontSize(9).SemiBold();
                ...
                foreach (var produto in _produtos)
                {
                    ...
                    var fornecedor = _fornecedores.FirstOrDefault(f => f.id == produto.fornecedor_fk);
                    string nomeFornecedor = fornecedor != null ? fornecedor.nome : "Desconhecido";
